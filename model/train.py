...
TEMPERATURE    = 0.07
DROPOUT        = 0.1
EVAL_EVERY     = 5        # evaluate more frequently to catch early AUC peak
PATIENCE       = 10       # stop after 50 epochs of no AUC improvement
TRAIN_SPLIT    = 0.85
TOP_PROBES     = 20000    # feature selection: top-N CpGs by inter-sample variance
...
dataset   = MethCLRDataset(matrices, label_map, top_probes=TOP_PROBES)
